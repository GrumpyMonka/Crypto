...
ThreadMonster::ThreadMonster( const QSet<QString>& words, const QMap<QString, QString>& slovar, int size_word, QWidget* parent )
    : QThread( parent ), words( words ), slovar( slovar ), size_word( size_word )
{
